    ...
    <script>
        ...
        channel.bind('cart-event', function(data) {
            ...
            switch (data.order.payment) {
                case 'Bca':
                    paymentText = 'Transfer BCA';
                    break;

                case 'Mandiri':
                    paymentText = 'Transfer Mandiri';
                    break;

                case 'Bni':
                    paymentText = 'Transfer BNI';
                    break;

                case 'Bri':
                    paymentText = 'Transfer BRI';
                    break;

                case 'Bsi':
                    paymentText = 'Transfer BSI';
                    break;

                case 'Cash':
                    paymentText = 'Pembayaran Tunai/Cash';
                    break;
            ...
            <tr>
                <td>
                    <input class="form-check-input" type="checkbox" value="${data.order.id}" name="select-item[]" data-uuid="${data.order.uuid}" data-status="Paid" data-menu-id="${data.order.menu_id}">
                </td>
